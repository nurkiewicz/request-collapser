...
```bash
FULL_NAME="Tomasz Nurkiewicz"
GITHUB_USER="nurkiewicz"
REPO_NAME="request-collapser"
sed -i.mybak "s/\([\/\"]\)(ryansonshine)/$GITHUB_USER/g; s/typescript-npm-package-template\|my-package-name/$REPO_NAME/g; s/Tomasz Nurkiewicz/$FULL_NAME/g" package.json package-lock.json README.md
rm *.mybak
```
